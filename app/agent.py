...
from app.toolkit.toolkit_registry import AppointmentToolkit
...
print(f"============> Availbility Tools: {availability_tools} \n")
...
class DoctorAppointmentAgent:
    def __init__(self):
        self.llm_model = LLMFactory.get_model("gpt-4o")
        print(f"=========> Model Initialized : {self.llm_model} \n")
    ...
    def information_node(self, state: AgentState) -> Command[Literal['supervisor']]:
        ...
        information_agent = create_react_agent(model=self.llm_model,tools=availability_tools ,prompt=system_prompt)
    ...
    def booking_node(self, state: AgentState) -> Command[Literal['supervisor']]:
        ...
        booking_agent = create_react_agent(model=self.llm_model,tools=management_tools,prompt=system_prompt)
